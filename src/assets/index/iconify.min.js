...
var Iconify = (function (e) {
  ...
  function i(e, n, i) {
    ...
    if (o) for (var a in r) void 0 === o[a] && void 0 !== e[a] && (o[a] = e[a]);
    return o && i ? t(o) : o;
  }
  var o = /^[a-f0-9]+(-[a-f0-9]+)*$/;
  function a(e, n) {
        ...
        !(function (e, t) {
          ...
          if ("object" == typeof c.chars) {
            ...
            Object.keys(p).forEach(function (e) {
              ...
              if (
                void 0 === c.icons[r] &&
                void 0 === (null == (n = c.aliases) ? void 0 : n[r])
              ) {
                if (i) return void delete p[e];
                throw new Error(
                  'Character "' + e + '" points to missing icon "' + r + '"'
                );
              }
            }),
  ...
  var f = function (e, n, r, t) {
      ...
      if (i.length > 1) {
        var o = i.pop(),
          a = i.pop(),
          c = { provider: i.length > 0 ? i[0] : t, prefix: a, name: o };
        return n && !u(c) ? null : c;
      }
      var f = i[0],
        s = f.split("-");
  ...
  function A(e, n) {
    ...
    [e, n].forEach(function (e) {
      ...
      switch (
        (t
          ? a
            ? (c += 2)
            : (r.push(
                "translate(" + (i.width + i.left) + " " + (0 - i.top) + ")"
              ),
              r.push("scale(-1 1)"),
              (i.top = i.left = 0))
          : a &&
      ...
      null === n.width && null === n.height
        ? (r = I((t = "1em"), i.width / i.height))
        : null !== n.width && null !== n.height
        ? ((r = n.width), (t = n.height))
        : null !== n.height
        ? (r = I((t = n.height), i.width / i.height))
        : (t = I((r = n.width), i.height / i.width)),
      "auto" === r && (r = i.width),
      "auto" === t && (t = i.height);
    var a = {
      attributes: {
  ...
  function F(e, n) {
    void 0 === n && (n = T);
    for (var r, t = []; (r = S.exec(e)); ) t.push(r[1]);
    return t.length
  ...
  function H(e) {
    var n = e + "Storage";
    try {
      if ($ && $[n] && "number" == typeof $[n].length) return $[n];
    } catch (e) {}
    return (U[e] = !1), null;
  }
  function V(e, n, r) {
    try {
      return e.setItem(D, r + ""), (q[n] = r), !0;
    } catch (e) {
      return !1;
    }
  }
          ...
          var t = function (n) {
            ...
            try {
              ...
              if (
                ...
                o = !1;
              else o = d(l(a.provider, a.data.prefix), a.data).length > 0;
            } catch (e) {
              o = !1;
            }
            ...
            if (i !== P)
              return (
                i &&
                  (function (e) {
                    try {
                      for (var n = J(e), r = 0; r < n; r++) e.removeItem(L + r);
                    } catch (e) {}
                  })(r),
                void (function (e, n) {
                  try {
  ...
  for (
    var Z = Object.create(null),
      ee = ["https://api.simplesvg.com", "https://api.unisvg.com"],
      ne = [];
    ee.length > 0;

  )
    1 === ee.length || Math.random() > 0.5
      ? ne.push(ee.shift())
      : ne.push(ee.pop());
  function re(e, n) {
    var r = X(n);
    return null !== r && ((Z[e] = r), !0);
  }
  function te(e) {
    return Z[e];
  }
  Z[""] = X({ resources: ["https://api.iconify.design"].concat(ne) });
  var ie = function (e, n) {
      var r = e,
        t = -1 !== r.indexOf("?");
      return (
  ...
  function ue() {
    if (null === oe) {
      ...
      if (void 0 === e[n])
        ...
        var t = e[n];
        void 0 === t.cb && (t.cb = Object.create(null)), (oe = t.cb);
      }
      ae = n + r + ".{cb}";
    }
    return oe;
  ...
  var se = {
          ...
          (i = (function (e, n) {
            ...
            if (t.maxURL) {
              ...
              t.resources.forEach(function (e) {
                ...
                ue();
              var o = ie(n + ".js", { icons: "", callback: ae });
              r = t.maxURL - i - t.path.length - o.length;
            } else r = 0;
            var a = e + ":" + n;
            return (fe[a] = t.path), (ce[a] = r), r;
          })(e, n));
        var o = "icons",
      ...
      send: function (e, n, r) {
        if ("icons" === n.type) {
          for (
            ...
            u++;
          var s = c + u,
            l = ie(i + ".js", { icons: o, callback: ae.replace("{cb}", s) }),
            d = fe[a] + l;
          f[s] = function (e) {
            delete f[s], r.done(e);
          };
    ...
    ve = (function () {
      ...
      try {
        ...
        if (
          "function" == typeof (e = (0, global[n + "qui" + n])("cross-fetch"))
        )
          return e;
      } catch (e) {}
      return null;
      ...
      void 0 === i &&
        (i = (function (e, n) {
          ...
          if (t.maxURL) {
            ...
            var o = ie(n + ".json", { icons: "" });
            r = t.maxURL - i - t.path.length - o.length;
          } else r = 0;
          var a = e + ":" + n;
          return (de[e] = t.path), (le[a] = r), r;
        })(e, n));
      var o = "icons",
        a = { type: o, provider: e, prefix: n, icons: [] },
        c = 0;
  ...
  function xe(e) {
    var n = (function (e) {
        ...
        for (n in me) void 0 !== e[n] ? (r[n] = e[n]) : (r[n] = me[n]);
        return r;
      })(e),
      r = [];
    function t() {
  ...
  function Ee(e, n, r) {
    ...
    if ("string" == typeof e) {
      var o = W(e);
      if (!o) return r(void 0, 424), je;
      i = o.send;
      var a = (function (e) {
        if (void 0 === Oe[e]) {
          var n = te(e);
          if (!n) return;
          var r = { config: n, redundancy: xe(n) };
          Oe[e] = r;
        }
        return Oe[e];
      })(e);
    ...
    return t && i ? t.query(n, i, r)().abort : (r(void 0, 424), je);
  }
  function Ie() {}
        ...
        (r[n] = !1),
          (function (e, n) {
            ...
            r[n] ||
              ((r[n] = !0),
              setTimeout(function () {
                if (((r[n] = !1), void 0 !== he[e] && void 0 !== he[e][n])) {
                  ...
                  if (t.length) {
                    ...
                    t.forEach(function (r) {
                      ...
                      (t.pending = t.pending.filter(function (r) {
                        ...
                        var a = r.name;
                        if (void 0 !== i.icons[a])
                          t.loaded.push({ provider: e, prefix: n, name: a });
                        else {
                          if (void 0 === i.missing[a]) return (o = !0), !0;
                          t.missing.push({ provider: e, prefix: n, name: a });
                        }
                        return !1;
                      })),
                        t.pending.length !== a &&
                          (o || ye([{ provider: e, prefix: n }], r.id),
                          r.callback(
                            t.loaded.slice(0),
                            t.missing.slice(0),
                            t.pending.slice(0),
  ...
  function Re(e, n, r, t) {
    ...
    if (c) {
      var E = { name: f, status: "loaded", customisations: n };
      (d[Ne] = E), (d[De] = c);
    }
    var I = t ? i.innerHTML : d;
    return (
      a && a.parentNode ? a.parentNode.replaceChild(d, a) : i.removeChild(d), I
    );
  }
  var Ue = [];
  function ze(e) {
  ...
  function qe(e, n) {
    ...
    return r
      ...
      : ((r = { node: e, temporary: n }), Ue.push(r), r);
  }
  function _e() {
    return Ue;
  }
  var $e = null,
    He = { childList: !0, subtree: !0, attributes: !0 };
  function Ve(e) {
    if (e.observer) {
      var n = e.observer;
      n.pendingScan ||
        (n.pendingScan = setTimeout(function () {
          delete n.pendingScan, $e && $e(e);
        }));
    }
  }
  function Je(e, n) {
      ...
      if (!r.pendingScan)
        for (var t = 0; t < n.length; t++) {
          ...
          if (
            ...
            ("attributes" === i.type && void 0 !== i.target[De])
          )
        ...
        if (t && i) {
          ...
          if (null !== o) {
            ...
            if (
              ...
              var f = { element: r, finder: t, name: o, customisations: a };
              n.push(f);
            }
          }
        }
          ...
          if (
            ...
            switch (p.status) {
              case "missing":
                return;
              case "loading":
                if (Pe({ provider: u, prefix: s, name: d }))
                  return void (i = !0);
            }
          var h = l(u, s);
          if (void 0 === h.icons[d]) {
            ...
            if (!Pe({ provider: u, prefix: s, name: d })) {
              ...
              var g = r[u];
              void 0 === g[s] && (g[s] = Object.create(null)), (g[s][d] = !0);
            }
            (p = { name: f, status: "loading", customisations: {} }),
              (c[Ne] = p),
              (i = !0);
          } else {
            !o && e.observer && (We(e), (o = !0));
            var y =
  ...
  var vn = ["inline", "hFlip", "vFlip"],
    ...
    gn = {
      ...
      customisations: function (e, n) {
        ...
        if (
          (-1 !== (i ? i.split(/\s+/) : []).indexOf(hn) && (t.inline = !0),
          ln(e, "data-rotate"))
        ) {
          var o = (function (e, n) {
            void 0 === n && (n = 0);
  ...
  function yn(e, n, r) {
    var t = g(e);
    return t
      ? Re({ name: f(e) }, j(x, "object" == typeof n ? n : {}), t, r)
      : null;
  }
  function bn() {
    return "2.1.0";
  ...
  function jn(e) {
    e
      ? (function (e) {
          var n = ze(e);
          n ? un(n) : un({ node: e, temporary: !0 }, !0);
        })(e)
      : un();
  }
  if ("undefined" != typeof document && "undefined" != typeof window) {
    !(function () {
      if (document.documentElement) return qe(document.documentElement);
      Ue.push({
        node: function () {
    ...
    if (void 0 !== On.IconifyPreload) {
      ...
      "object" == typeof En &&
        null !== En &&
        (En instanceof Array ? En : [En]).forEach(function (e) {
          try {
            ("object" != typeof e ||
              null === e ||
              e instanceof Array ||
  ...
  if (
    ...
    (B.store = function (e, n) {
      function r(r) {
        ...
        if (!t) return !1;
        var i = _[r].shift();
        if (void 0 === i && !V(t, r, (i = q[r]) + 1)) return !1;
        try {
          var o = { cached: Math.floor(Date.now() / R), provider: e, data: n };
